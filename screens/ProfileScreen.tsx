...
const defaultHistoryData: History[] = [ 
  {
    ...
    description: 'Paper gift card with expiration date on 1/1/2025.',               
    time: '1 minute ago',
    rating: 5,
  },
  {
    id: '2',
    title: 'Request',
    subtitle: 'Expiring Uber Eats Credit',
    description: 'Looking for a $20-50 Uber Eats coupon that will be expiring soon.',
    time: '30 minutes ago',
  },
  {
    id: '3',                             
    title: 'Match',
    subtitle: 'Math tutor',
    description: 'I need help preparing for me MA261 final.',               
    time: '1 hour ago',
    rating: 1,
  },
];
