...
export declare class OrganizationalEntity implements Comparable<OrganizationalEntity> {
    name?: string;
    url: Set<URL | string>;
...
export declare class OrganizationalEntityRepository extends SortableComparables<OrganizationalEntity> {
}
